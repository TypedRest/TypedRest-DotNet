...
namespace TypedRest
{
    public class ActionEndpointTEntityTest : EndpointTestBase
    {
        ...
        public async Task TestTrigger()
        {
            ...
            await _endpoint.TriggerAsync(mockEntity);
        ...
        {
            // Have to create a new object, otherwise it's the same object reference
            ...
            return httpRequestMessage.CreateResponse(HttpStatusCode.NoContent);
        }
    }
}